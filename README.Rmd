...
- `text_split`: Splits documents in a corpus into sequences which LLMs can process
...
corpus <- quanteda::data_corpus_inaugural # load the inaugural address corpus as example data
...
```{.r}
library(quanteda.llm)
ai_qualies <- ai_qual(corpus_split, "splits", "llama3.2", 
