...
**PLEASE NOTE: The quanteda.llm package is no longer actively maintained. Please check out our new [quallmer](https://github.com/SeraphineM/quallmer) package for up-to-date functionality for AI-assisted annotation to texts, images, pdfs, tabular data and other structured data.**
