---
title: "Get the Importance scores from Ollama llama-3.3-70B"
author: "Ken Benoit"
format: html
execute:
  echo: true
...
### Get llama-3.3-70B scores for all manifestos
...
```{r}
saveRDS(results_df, file = "importance_scores_Gemini_1.5_pro_all.rds")
# results_df <- readRDS("importance_scores_Gemini_1.5_pro_all.rds")
```
...
# save it
saveRDS(results_df, file = "importance_scores_Gemini_1.5_pro_all_complete.rds")
```
