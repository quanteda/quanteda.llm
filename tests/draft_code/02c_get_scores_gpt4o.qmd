---
title: "Get the Importance scores from GPT-4o"
author: "Ken Benoit"
format: html
execute:
  echo: true
...
### Get GPT-4o scores for all manifestos
...
```{r}
saveRDS(results_df, file = "importance_scores_GPT-4o_all.rds")
```
...
results_df <- readRDS("importance_scores_GPT-4o_all.rds")
...
```{r}
saveRDS(results_df, file = "importance_scores_GPT-4o_all_complete.rds")
```
